...
g2 <- ggplot(detalle, aes(x = reorder(Region, Total), y = Total)) +
  ...
  theme_reporte
ggsave("img/chart_region.png", g2, width = 6.2, height = 4.3, dpi = 300, bg = "white")
...
ggsave("img/chart_producto.png", g3, width = 6.5, height = 5, dpi = 300, bg = "white")
...
print(doc, target = "Reporte_Ventas_2026.pptx")
